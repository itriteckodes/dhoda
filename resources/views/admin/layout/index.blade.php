...
<head>
	...
	<title>{{Auth::user()->name}} | ADMIN PANEL | GYNOBST </title>
			...
			<div class="sidebar-content">
					...
					<div class="card-body">
						<div class="media">
							...
							<div class="media-body">
								...
								<div class="font-size-xs opacity-50">GYNOBST Inc.
								</div>
							</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="{{route('admin.product_category.index')}}" class="nav-link {{Request::is('admin/product_category')?'active':''}}">
								<i class="icon-folder-plus"></i>
								<span>Product Category</span>
							</a>
						</li>	
						<li class="nav-item nav-item-submenu {{Request::is('admin/product/*') || Request::is('admin/product')?'nav-item-open':''}}">
							<a href="#" class="nav-link"><i class="icon-stack2"></i> <span>Products</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts" style="{{Request::is('admin/product/*') || Request::is('admin/product')?'display:block':''}}">
								<li class="nav-item"><a href="{{route('admin.product.create')}}" class="nav-link {{Request::is('admin/product/create')?'active':''}}">Add Product</a></li>
								<li class="nav-item">
									<a href="{{route('admin.product.index')}}" 
									class="nav-link two-dates {{Request::is('admin/product')?'active':''}}">All Products</a>
								</li>
							</ul>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item nav-item-submenu {{Request::is('admin/blog/*') || Request::is('admin/blog')?'nav-item-open':''}}">
							<a href="#" class="nav-link"><i class="icon-stack2"></i> <span>Blogs</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts" style="{{Request::is('admin/blog/*') || Request::is('admin/blog')?'display:block':''}}">
								<li class="nav-item"><a href="{{route('admin.blog.create')}}" class="nav-link {{Request::is('admin/blog/create')?'active':''}}">Add Blogs</a></li>
								<li class="nav-item">
									<a href="{{route('admin.blog.index')}}" 
									class="nav-link two-dates {{Request::is('admin/blog')?'active':''}}">All Blogs</a>
								</li>
							</ul>
						</li>

						<li class="nav-item nav-item-submenu {{Request::is('admin/order/*') || Request::is('admin/order')?'nav-item-open':''}}">
							<a href="#" class="nav-link"><i class="icon-stack2"></i> <span>Orders</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts" style="{{Request::is('admin/order/*') || Request::is('admin/order')?'display:block':''}}">
								<li class="nav-item"><a href="{{route('admin.order.index')}}" class="nav-link {{Request::is('admin/order')?'active':''}}">All Orders</a></li>
								<li class="nav-item"><a href="{{route('admin.pending.order')}}" class="nav-link {{Request::is('admin/order/pending')?'active':''}}">Pending Orders</a></li>
								<li class="nav-item"><a href="{{route('admin.completed.order')}}" class="nav-link {{Request::is('admin/order/completed')?'active':''}}">Completed Orders</a></li>
							</ul>
						</li>
						<li class="nav-item">
