                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group ">
                                    ...
                                    <img id="preview_img" src="{{ asset('images/blog/721606330121.jpg') }}" height="240"
                                        width="320" style="padding-bottom: 10px;" alt="">
                                    <label for="main-image">Main Image*</label>
                                    <input type="file" value="{{ old('image') }}" name="image" id="profile_image"
                                        onchange="loadPreview(this);" class="form-input-styled" accept="image/*" required>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="form-group">
