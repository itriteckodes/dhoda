                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="producudetails_content">
                        ...
                        <div class="add_to_cart d-flex">
                            ...
                            <a href="cartoverview.html" class="btn border-transparent ml-5 cart-add" id="{{$product->id}}">Add to cart</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="product">
                            ...
                            <div class="product-content">
                                <div class="product-details position-bottom-left">
                                    <h3 class="product-name"><a href="{{route('product.show',str_replace(' ', '_',$category_product->name))}}" >{{$category_product->name}}</a></h3>
                                    <span class="product-price">{{$category_product->price}}</span>
                                </div>
                                <div class="buttons">
                                    <button class="btn custom-btn position-bottom-right addcart-item" id="{{$category_product->id}}"> Add to cart</button>
                                </div>

                                <div class="icons position-center">
                                    <div class="rounded-icon">
                                       <a href="{{route('product.show',str_replace(' ', '_',$category_product->name))}}"><i class="icofont-eye"></i></a> 
                                    </div>
                                </div>
                            </div>
                        </div>
