...
<head>
	...
	<title>{{ strtoupper(Auth::user()->name)}}  PANEL | GYNOBST </title>
	...
	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand">
			<a href="{{url('/')}}" class="text-light">
				<h3 class="m-0"><b>User Panel Menu</b></h3>
			</a>
		</div>
			...
			<div class="sidebar-content">
					...
					<div class="card-body">
						<div class="media">
							...
							<div class="media-body">
								...
								<div class="font-size-xs opacity-50">LMS Inc.
								</div>
							</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu {{Request::is('user/order/*') || Request::is('user/order')?'nav-item-open':''}}">
							<a href="#" class="nav-link"><i class="icon-stack2"></i> <span>Orders</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts" style="{{Request::is('user/order/*') || Request::is('user/order')?'display:block':''}}">
								<li class="nav-item"><a href="{{route('user.order.index')}}" class="nav-link {{Request::is('user/order')?'active':''}}">All Orders</a></li>
								<li class="nav-item"><a href="{{route('user.pending.order')}}" class="nav-link {{Request::is('user/order/pending')?'active':''}}">Pending Orders</a></li>
								<li class="nav-item"><a href="{{route('user.completed.order')}}" class="nav-link {{Request::is('user/order/completed')?'active':''}}">Completed Orders</a></li>
							</ul>
						</li>
						{{-- <li class="nav-item nav-item-submenu {{Request::is('user/course/*') || Request::is('user/course')?'nav-item-open':''}}">
							<a href="#" class="nav-link"><i class="icon-stack2"></i> <span>Courses</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts" style="{{Request::is('user/course/*') || Request::is('user/course')?'display:block':''}}">
								<li class="nav-item"><a href="{{route('user.course.index')}}" class="nav-link {{Request::is('user/course')?'active':''}}">Courses</a></li>
								<li class="nav-item">
									<a href="{{route('user.course.purchased')}}" 
									class="nav-link two-dates {{Request::is('user/course/purchased')?'active':''}}">Purchased Courses</a>
								</li>
							</ul>
						</li> --}}
						{{-- <li class="nav-item nav-item-submenu {{Request::is('user/quiz/*') || Request::is('user/quiz')?'nav-item-open':''}}">
							<a href="#" class="nav-link"><i class="icon-stack2"></i> <span>Quiz</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts" style="{{Request::is('user/quiz/*') || Request::is('user/quiz')?'display:block':''}}">
								<li class="nav-item"><a href="{{route('user.quiz.index')}}" class="nav-link {{Request::is('user/quiz')?'active':''}}">Course Quiz</a></li>
								<li class="nav-item">
									<a href="{{route('user.quiz.results')}}" 
									class="nav-link two-dates {{Request::is('user/quiz/results')?'active':''}}">Taken Quiz Results</a>
								</li>
							</ul>
						</li>		 --}}
						{{-- <li class="nav-item">
